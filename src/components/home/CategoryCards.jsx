...
const defaultOtherCategories = [
  ...
  { id: "buy_sell",   icon: IconStore,      iconColor: "#eab308", title: "Buy & Sell",   sub: "Accounts, Items, Gear, Gift Cards & Premium Mods",   color: "from-yellow-950 to-yellow-900", borderColor: "border-yellow-500/50", glowColor: "rgba(234,179,8,0.6)",  href: "/category?cat=buy_sell",    badge: "All Users" },
  ...
  { id: "livestream", icon: IconStream,     iconColor: "#f87171", title: "Live Streams", sub: "Watch & Go Live Now",                                 color: "from-red-950 to-red-900",       borderColor: "border-red-500/50",    glowColor: "rgba(239,68,68,0.6)",  href: "/category?cat=livestream",  live: true, badge: "LIVE" },
  { id: "content",    icon: IconPlay,       iconColor: "#60a5fa", title: "Content",      sub: "Videos, Clips, Reviews & Highlights",                color: "from-blue-950 to-blue-900",     borderColor: "border-blue-500/50",   glowColor: "rgba(59,130,246,0.6)", href: "/category?cat=content",     badge: "Videos" },
  ...
  { id: "services",   icon: IconServices,   iconColor: "#818cf8", title: "Services",     sub: "PC Repair, Coaching, Design & More",                 color: "from-indigo-950 to-indigo-900", borderColor: "border-indigo-500/50", glowColor: "rgba(99,102,241,0.6)", href: "/category?cat=services",    badge: "Pro Help" },
];
