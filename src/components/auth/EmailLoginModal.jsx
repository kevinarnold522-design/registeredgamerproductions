...
export default function EmailLoginModal({ isOpen, onClose }) {
  ...
  // UPDATED: Forced account selection for Google
        ...
        >
          ...
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-2">
              ...
              <span className="text-white font-black text-sm">Sign In to GAMER</span>
            </div>
          ...
          {/* Steps omitted for brevity: keep your existing step rendering here... */}
          {/* Ensure you use the updated loginWithProvider in the Social Tab */}
