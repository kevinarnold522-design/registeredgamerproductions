...
export const MASCOTS = [
  ...
  },
  {
    ...
    image: "https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=JapanLeopard&scale=90&backgroundColor=ff6b6b",
    country: "Japan",
    animal: "Leopard",
    keywords: ["japan", "gaming", "esports", "leopard", "competitive"],
  ...
  },
  {
    ...
    name: "UK Lion",
    role: "Sports Gaming",
    image: "https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=UKLion&scale=90&backgroundColor=ffa500",
    country: "United Kingdom",
    animal: "Lion",
    keywords: ["uk", "gaming", "sports", "lion", "football"],
    glow: "rgba(255,165,0,0.75)",
  },
  {
    id: "france-rooster",
    name: "French Rooster",
    role: "Arcade Master",
    image: "https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=FranceRooster&scale=90&backgroundColor=4169e1",
    country: "France",
    animal: "Rooster",
    keywords: ["france", "gaming", "arcade", "rooster", "european"],
    glow: "rgba(65,105,225,0.75)",
  },
  {
    id: "korea-fox",
    name: "Korea Fox",
    role: "Pro Player",
    image: "https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=KoreaFox&scale=90&backgroundColor=22c55e",
    country: "South Korea",
    animal: "Fox",
    keywords: ["korea", "gaming", "pro", "fox", "competitive"],
