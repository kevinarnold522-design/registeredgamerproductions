                      ...
                      <div className="mt-2 rounded-2xl border border-purple-700/30 bg-[linear-gradient(180deg,rgba(32,14,56,0.94),rgba(11,8,25,0.96))] p-2">
                        <div className="grid grid-cols-2 gap-2">
                          {[
                            ...
                            <div key={metric.label} className={`rounded-xl border border-white/10 bg-gradient-to-r ${metric.tone} px-2.5 py-2 text-left ${metric.isPoints ? "shadow-[0_0_18px_rgba(217,70,239,0.14)]" : ""}`}>
                              <div className="mb-1 flex items-center justify-between gap-2">
                                <p className={`text-[8px] font-black ${metric.isPoints ? "text-fuchsia-100/75" : "text-gray-400"}`}>{metric.label}</p>
                              ...
                              {metric.isPoints ? (
                                <div className="flex items-end justify-between gap-2">
                                  <div>
                                    ...
                                    <p className="mt-1 text-[8px] uppercase tracking-[0.16em] text-fuchsia-100/75">points</p>
                                  </div>
                                  <p className="text-[8px] uppercase tracking-[0.16em] text-gray-300/60">score</p>
                                </div>
                              ) : (
                                <div className="flex items-end justify-between gap-2">
                                  <p className={`text-base font-black leading-none ${metric.valueClassName || "text-white"}`}>{metric.value}</p>
                                  <p className={`text-[8px] uppercase tracking-[0.16em] ${metric.accent}`}>{metric.rank}</p>
                                </div>
                              )}
                            </div>
                          ))}
