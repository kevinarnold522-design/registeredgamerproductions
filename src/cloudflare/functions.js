...
async function createPaypalOrder(body, env, request) {
  ...
  const { amount, currency = "PHP", items = [], description = "GAMER Productions Purchase" } = body;
